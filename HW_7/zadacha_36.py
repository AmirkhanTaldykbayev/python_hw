...
def print_operation_table(operation, num_rows, num_columns):
    for i in range(1, num_rows + 1):
        ...
        for j in range(1, num_columns + 1):
            print(operation(i, j), end=" | ")                   # пришлось гуглить как сюда прикрутить лямбду


print_operation_table(lambda x, y: x * y, rows, columns)        # в лекции к сожалению не объяснили, что после вызова лямбды, нужно
                                                                # через запятую вводить значения переменных, мб я невнимательно посмотрел
